...
$gdMemo = $imagickMemo = 'Either GD PHP extension with FreeType support or imageFileMagick PHP extension with PNG support is required for imageFile CAPTCHA.';
...
if (extension_loaded('imagick')) {
    ...
    if (in_array('PNG', $imagickFormats)) {
        ...
        $imagickMemo = 'Imagick extension should be installed with PNG support in order to be used for imageFile CAPTCHA.';
    }
}
...
if (extension_loaded('gd')) {
    ...
    if (!empty($gdInfo['FreeType Support'])) {
        ...
        $gdMemo = 'GD extension should be installed with FreeType support in order to be used for imageFile CAPTCHA.';
    }
}
...
$requirements = array(
    ...
    array(
        'name' => 'imageFileMagick PHP extension with PNG support',
        'mandatory' => false,
        'condition' => $imagickOK,
        'by' => '<a href="https://www.yiiframework.com/doc-2.0/yii-captcha-captcha.html">Captcha</a>',
        'memo' => $imagickMemo,
